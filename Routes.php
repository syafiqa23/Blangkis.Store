...
$routes->get('invoice', 'TransaksiController::invoiceRedirect', ['filter' => 'auth']);
$routes->get('invoice/(:num)', 'TransaksiController::invoice/$1', ['filter' => 'auth']);
$routes->get('invoice-detail/(:num)', 'InvoiceController::show/$1', ['filter' => 'auth']);
$routes->get('invoice-detail-pdf/(:num)', 'InvoiceController::print/$1', ['filter' => 'auth']);
...
$routes->get('checkout/success', 'CheckoutController::success', ['filter' => 'auth']);
$routes->post('upload-bukti/(:num)', 'TransaksiController::uploadBuktiPembayaran/$1', ['filter' => 'auth']);
